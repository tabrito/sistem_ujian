...
<main>
  <div>
    <h1 style="margin-left: 200px;">Hasil Ujian</h1>
  </div>
  <div class="content-produk">
    ...
    <table class="table-produk">
      ...
      <?php
      $i = 1;
      $ambildata = mysqli_query($mysqli, "SELECT * FROM mapel, guru where mapel.id_guru=guru.nip group by mapel order by mapel asc") or die('Ada kesalahan pada query : ' . mysqli_error($mysqli));
      ...
      ?>
        <tr>
          ...
          $ambilmapel = mysqli_query($mysqli, "SELECT * FROM ujian, nilai where nilai.id_ujian=ujian.id_ujian and id_mapel='$id_mapel' group by jenis_ujian") or die('Ada kesalahan pada query : ' . mysqli_error($mysqli));
